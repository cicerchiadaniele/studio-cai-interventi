# Studio CAI – Interventi (uso interno) v2.1
...
Versione 2.1 del 23/09/2026 (vedi CHANGELOG_v2.1.md): stesse funzioni della 2.0 con meno
chiamate a Make (elenco condomini salvato sul dispositivo per 7 giorni, controllo doppioni
una sola volta all'invio).
