...
## Versione 2.0 (22/09/2026)

- Numero di versione: 2.0 (in intestazione, piè di pagina e appVersion
  inviata a Make: "Interventi studio 2.0").
- Nuovi tipi di intervento: Contabilizzazione (calore e acqua), Fognature,
  Pulizia, Videosorveglianza; 15 tipi in tutto, allineati al portale
  condomini 2.0 e alla base Airtable "FORNITORI CONDOMINI". Nessun allegato
  per i nuovi tipi. Lo scenario Segnalazioni li registra e li segnala allo
  studio senza inoltro a ditte.
- Icone: scopa per Pulizia, tombino per Fognature, contatore per
  Contabilizzazione, telecamera per Videosorveglianza.
- Griglia dei tipi: stessa dimensione del testo per tutte le voci, nessuna
  voce va a capo; 3 colonne da 768 px in su, 2 colonne sotto.
- Riquadro "Nuovo intervento": tolta la scritta "I campi con * sono
  obbligatori" (restano gli asterischi), sfondo senza puntini, titolo centrato.

Contenuti dell'aggiornamento del 22/09/2026 mattina (inclusi nella 2.0):

- Controllo doppioni con la descrizione: il pannello del controllo ora sta
  sotto la Descrizione. Scelti condominio e tipo compaiono le segnalazioni
  dello stesso tipo sul condominio negli ultimi 14 giorni ("Stesso tipo già
  segnalato… Scrivi la descrizione"); appena si esce dal campo Descrizione il
  controllo si ripete confrontando anche la descrizione e restano solo i
  problemi simili ("Possibile doppione: problema simile già segnalato"), oltre
  a quelli con lo stesso scala/interno. All'invio, se il controllo con la
  descrizione non è ancora concluso, viene fatto in quel momento; se Make non
  risponde l'intervento si invia comunque. La descrizione viaggia al webhook
  del controllo (scenario 7467174) nel campo `messaggio`.
- Nuovo tipo di intervento "Pulizia" (nella 2.0 esteso anche al portale
  condomini). Lo scenario Segnalazioni non lo instrada a ditte: registra
  sul foglio e avvisa lo studio (email e Telegram), come Ascensore o
  Giardinaggio. Niente allegati. Nella mail di conferma al contatto in loco
  l'ambito è "Pulizia delle parti comuni".
- "Ultimi interventi da questo dispositivo": tolto il contatore 10/10
  (l'elenco resta limitato agli ultimi 10 invii).
- Data nel piè di pagina: 22/09/2026.

## Prima versione (17/09/2026)
